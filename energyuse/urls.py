...
from energyuse.apps import consumption
from energyuse.apps.concepts import views as concepts
...
from energyuse.apps.consumption import views as cviews


urlpatterns = patterns('',

    # Post listing.
    url(r'^$', views.PostListHome.as_view(), name="home"),
    ...
    # Topic listing.
    url(r'^t/(?P<topic>.+)/$', eviews.TagPage.as_view(), name="topic-list"),
    url(r'^t/(?P<topic>.+)/subscribe$', concepts.subscribe, name="topic-subscribe"),
    ...
    # Consumption data
    url(r'^u/(?P<slug>\d+)/data', eviews.data, name="user-details"),

    # User details.
    url(r'^u/(?P<pk>\d+)/$', eviews.UserDetails.as_view(), name="user-details"),

    # User details.
    url(r'^u/edit/(?P<pk>\d+)/$', eviews.EditUser.as_view(), name="user-edit"),


    # Add manual consumption:
    url(r'^c/$', cviews.EditManualEnergyConsumption.as_view(), name="consumption-edit"),



    # EnergyNote details.
    url(r'^u/energynote/edit/(?P<pk>\d+)/$', eviews.EditEnergyNote.as_view(), name="energynote-edit"),


    # Post details.
    url(r'^p/(?P<pk>\d+)/$', eviews.PostDetails.as_view(), name="post-details"),
